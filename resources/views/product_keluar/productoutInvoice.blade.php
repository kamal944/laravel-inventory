    ...
    <div class="header">
        ...
        <div>
            ...
            <div style="text-align: center;">
                ...
                <div>{{ __('main.invoice_number') }}: INV-{{ now()->format('YmdHis') }}</div>
            </div>
        </div>
    </div>

    @if($product_keluar->isNotEmpty())
        @php
            $firstProduct = $product_keluar->first();
            $customer = $firstProduct->customer; // Assuming all products have same customer
        @endphp
        ...
        <table class="info-table">
            <tr>
                ...
                <td>
                    <strong>{{ __('main.name') }}: {{ $customer->name ?? 'N/A' }}</strong><br>
                    {{ __('main.phone') }}: {{ $customer->phone ?? 'N/A' }}<br>
                    {{ __('main.address') }}: {{ $customer->address ?? 'N/A' }}<br>
                    {{ __('main.email') }}: {{ $customer->email ?? 'N/A' }}
                </td>
        ...
        <table class="items-table">
            ...
            @foreach($product_keluar as $index => $product)
                @php
                ...
                <tr>
                    ...
                    <td style="text-align: center;">  @if(app()->getLocale() === 'ar')
        ...
        <div class="signature-container">
            <div class="signature-box left-signature">
                ...
                <div>{{ $customer->name ?? 'N/A' }}<span class="parentheses">(  )</span></div>
            </div>
